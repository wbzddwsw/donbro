...
经过几次修改，目前 misskey 的基础功能介绍放在，本文是星屑专属的进阶版，如果是第一次使用 misskey 的朋友，推荐先看那篇哦。
...
3. MFM语法使用说明书：查看MFM语法具体效果，可以直接复制
4. 插件
...
1. **Bubble**：推荐时间线，显示站长选择的部分misskey系实例的公开帖子。相当于阉割版的全局时间线
...
1. **时间线和帖子** 自动折叠被回复帖子、自动折叠文件、时间线上的帖子分开显示、帖子风格（misskey风格的头像会跟随帖子上下滚动）、设置回应大小、显示帖子服务器来源
